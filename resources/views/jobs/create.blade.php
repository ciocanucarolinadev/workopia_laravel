...
>
    ...
    @csrf
        ...
        <x-inputs.text-area id="description" name="description" label="Description" placeholder="We are seeking a skilled and motivated Software Developer to join our growing development team..." />
        ...
        <x-inputs.text id='contact_email' name='contact_email' type='email' label="Contact Email" placeholder="Enter Contact Email" />
