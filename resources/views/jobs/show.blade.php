<x-layout>
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <section class="md:col-span-3">
            ...
            <div class="container mx-auto p-4">
                        ...
                        <div @click.away="open = false" class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                            ...
                            <form method="POST" action="{{ route('applicant.store', $job->id) }}"
                                ...
                                <button @click="open = false"
                                    class="bg-gray-300 hover:bg-gray-400 text-white px-4 py-2 rounded-md">
                                    Cancel
                                </button>
                            </form>
                        </div>
                ...
                <p class="my-5 bg-gray-200 rounded-md p-3">
                    <i class="fas fa-info-circle mr-3"></i> You must be logged in to apply to this job.
                </p>
        ...
        <aside class="bg-white rounded-lg shadow-md p-3">
            ...
            <!-- Bookmark Button -->
            @guest
            <p class="mt10 bg-gray-200 text-gray-700 font-bold w-full py-2 px-4 rounded-full text-center">
