    ...
    <section class="flex flex-col md:flex-row gap-4">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                ...
                <button type="submit"
                    class="w-full bg-green-500 hover:bg-green-600 focus:outline-none text-white px-4 py-2 border-rounded">
                    Save
                </button>
            </form>
        </div>
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            <div class="flex justify-between items-center border-b-2 border-gray-200 py-2">
                <div>
                    <h3 class="text-xl font-smibold">{{ $job->title }}</h3>
            ...
            <div class="mt-4 bg-gray-100 p-2">
                ...
                <form method="POST" action="{{ route('applicant.destroy', $applicant->id) }}"
                    ...
                    @csrf
                    @method('DELETE')
                    <button class="text-red-500 text-sm hover:text-red-700 mb-5" type="submit">
